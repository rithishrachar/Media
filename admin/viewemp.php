...
$sql = "SELECT * FROM `employee` WHERE `degree`='employee'";
	...
	<header>
		<nav>
			...
			<ul id="navli">
				...
				<li><a class="homeblack" href="viewuser.php">VIEW USERS</a></li>
				<li><a class="homeblack" href="viewadmin.php">VIEW ADMINS</a></li>
