...
// Retrieve the passed invoice number from the URL parameter
$invoiceNumber = $_GET['invoice_number'];

// Retrieve the advertisement details based on the matching invoice number
$sql = "SELECT * FROM advertisements WHERE invoice_number = '$invoiceNumber'";
...
if ($result->num_rows > 0) {
    ...
    // Generate and output the PDF with the retrieved data
